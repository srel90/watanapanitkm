<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="position.aspx.cs" Inherits="wattanapanitkm.position" %>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<form class="form-horizontal" role="form" id="scriptForm" name="scriptForm" method="post" action="position.aspx">
												<input type="hidden" id="txt-mode" name="mode" value="insert">
												<input type="hidden" id="txt-id" name="id">
                                                <div class="form-group">
												  <label for="txt-name" class="col-sm-2 control-label">Position Name*</label>
												  <div class="col-sm-3">
													<input type="text" class="form-control" id="txt-name" name="name" placeholder="Position Name">
													</div>
												</div>
                                                <div class="form-group">
		    ...
		    var script = new function () {
		        ...
		        this.eventhandle = function () {
		            ...
		            $('#btn-edit').click(function () {
		                ...
		                $('#txt-id').val(selectedItem.positionID);
		            ...
		            $("#btn-delete").click(function () {
		                ...
		                if (confirm('Do you want to delete this record?')) {
		                    if (ajax('position.aspx', ({ mode: 'delete', id: selectedItem.positionID })) == 'true') {
		                        script.clearform();
		                    } else {
		        ...
		        this.validation = function () {
		            validator = $('#scriptForm').kendoValidator({
		                rules: {
		                    verifyPositionName: function (input) {
		                        var ret = true;
		                        if (input.is('#txt-name')&&$('#txt-name').val()!="") {
		                            var cdata = ajax('position.aspx', ({ mode: 'verifyPositionName', name: input.val() }), false);
		                ...
		                messages: {
		                    verifyPositionName: "This position is already exist!",
		                    requirePositionName: "Position name is required!",
		                }
		            }).data("kendoValidator");
		        }//end validator
