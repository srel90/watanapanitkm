<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateemployee.aspx.cs" Inherits="wattanapanitkm.updateemployee" %>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<form class="form-horizontal" role="form" id="scriptForm" name="scriptForm" method="post" action="updateemployee.aspx">
												<input type="hidden" id="txt-mode" name="mode" value="update">
												<input type="hidden" id="txt-id" name="id" value="<% Response.Write(((System.Data.DataTable)Session["USER"]).Rows[0]["employeeID"].ToString());%>">
                                                <div class="form-group">
												  <label for="txt-name" class="col-sm-2 control-label">name</label>
												  <div class="col-sm-3">
													<input type="text" class="form-control" id="txt-name" name="name" placeholder="Name" value="<% Response.Write(((System.Data.DataTable)Session["USER"]).Rows[0]["name"].ToString());%>">
													</div>
												</div>
                                                <div class="form-group">
												  <label for="txt-username" class="col-sm-2 control-label">Username</label>
												  <div class="col-sm-3">
													<input type="text" class="form-control" id="txt-username" name="username" placeholder="Username" value="<% Response.Write(((System.Data.DataTable)Session["USER"]).Rows[0]["username"].ToString());%>" readonly>
													</div>
												</div>
                                                <div class="form-group">
