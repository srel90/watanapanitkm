<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="part.aspx.cs" Inherits="wattanapanitkm.part" %>
...
<html>
    <head>
        ...
        <style>
            ...
            #txt-departmentID-list .k-item > span {
                -webkit-box-sizing: border-box;
                -moz-box-sizing: border-box;
                box-sizing: border-box;
                display: inline-block;
            ...
            #txt-departmentID-list .k-item > span:first-child {
                width: 100px;
                border-left-width: 0;
                padding: .6em 0 0 0;
            }
					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<h3 class="panel-title">Part Management</h3>
								</div>
								<div class="panel-body">
									...
									<div class="panel panel-default">
										<div class="panel-heading">
										  <h3 class="panel-title">Part Data</h3>
										</div>
										<div class="panel-body">
											<form class="form-horizontal" role="form" id="scriptForm" name="scriptForm" method="post" action="part.aspx">
                                                ...
                                                <div class="form-group">
													...
													<div class="col-sm-3">
														<input id="txt-departmentID" name="departmentID" placeholder="Department" required validationMessage="Department is required!" style="width:400px">
													</div>
												</div>
												<div class="form-group">
												  <label for="txt-code" class="col-sm-2 control-label">Part Code</label>
												  <div class="col-sm-3">
													<input type="text" class="form-control" id="txt-code" name="code" placeholder="Part code">
													</div>
												</div>
                                                <div class="form-group">
												  <label for="txt-name" class="col-sm-2 control-label">Part Name</label>
												  <div class="col-sm-3">
													<input type="text" class="form-control" id="txt-name" name="name" placeholder="Part Name">
													</div>
												</div>
                                                <div class="form-group">
		    ...
		    var script = new function () {
		        ...
		        this.eventhandle = function () {
		            $('#btn-headID').click(function () {
		                ...
		                $("#data-grid-headUser").data("kendoGrid").dataSource.read();
		                $("#data-grid-headUser").data("kendoGrid").refresh();
		            ...
		            $('#btn-edit').click(function () {
		                ...
		                $('#txt-id').val(selectedItem.partID);
		            ...
		            $("#btn-delete").click(function () {
		                ...
		                if (confirm('Do you want to delete this record?')) {
		                    if (ajax('part.aspx', ({ mode: 'delete', id: selectedItem.partID })) == 'true') {
		                        script.clearform();
		                    } else {
		        ...
		        this.validation = function () {
		            validator = $('#scriptForm').kendoValidator({
		                rules: {
		                    verifyPartCode: function (input) {
		                        var ret = true;
		                        if (input.is('#txt-code') && $('#txt-code').val() != "") {
		                            var cdata = ajax('part.aspx', ({ mode: 'verifyPartCode', code: input.val() }), false);
		                ...
		                messages: {
		                    verifyPartCode: "This part is already exist!",
		                    //requireDepartmentCode: "Department code is required!",
		                }
		            }).data("kendoValidator");
		        }//end validator
