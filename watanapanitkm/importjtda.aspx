<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="importjtda.aspx.cs" Inherits="wattanapanitkm.importjtda" %>
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Import JTDA</li>
                </ol>
            </section>
            <!-- Main content -->
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">JTDA</h3>
                            </div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" id="scriptForm" name="scriptForm" method="post" action="importjtda.aspx" enctype="multipart/form-data">
                                    <input type="hidden" id="txt-mode" name="mode" value="import">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">JTDA excel file</label>
                                        <div class="col-sm-6">
