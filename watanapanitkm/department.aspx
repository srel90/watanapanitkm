<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="department.aspx.cs" Inherits="wattanapanitkm.department" %>
...
<html>
    <head>
        ...
        <style>
            ...
            #txt-sectorID-list .k-item > span:first-child {
                width: 100px;
                border-left-width: 0;
                padding: .6em 0 0 0;
            }
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<form class="form-horizontal" role="form" id="scriptForm" name="scriptForm" method="post" action="department.aspx">
                                                ...
                                                <div class="form-group">
													...
													<div class="col-sm-3">
														<input id="txt-sectorID" name="sectorID" placeholder="Sector" required validationMessage="Sector is required!" style="width:400px">
													</div>
												</div>
												<div class="form-group">
												  <label for="txt-code" class="col-sm-2 control-label">Department Code</label>
												  <div class="col-sm-3">
													<input type="text" class="form-control" id="txt-code" name="code" placeholder="Department code">
													</div>
												</div>
                                                <div class="form-group">
												  <label for="txt-name" class="col-sm-2 control-label">Department Name</label>
												  <div class="col-sm-3">
													<input type="text" class="form-control" id="txt-name" name="name" placeholder="Department Name">
													</div>
												</div>
                                                <div class="form-group">
		    ...
		    var script = new function () {
		        ...
		        this.eventhandle = function () {
		            ...
		            $('#btn-edit').click(function () {
		                ...
		                $('#txt-id').val(selectedItem.departmentID);
		            ...
		            $("#btn-delete").click(function () {
		                ...
		                if (confirm('Do you want to delete this record?')) {
		                    if (ajax('department.aspx', ({ mode: 'delete', id: selectedItem.departmentID })) == 'true') {
		                        script.clearform();
		                    } else {
		        ...
		        this.validation = function () {
		            validator = $('#scriptForm').kendoValidator({
		                rules: {
		                    verifySectorCode: function (input) {
		                        ...
		                        if (input.is('#txt-code') && $('#txt-code').val() != "") {
		                            var cdata = ajax('department.aspx', ({ mode: 'verifyDepartmentCode', code: input.val() }), false);
		                ...
		                messages: {
		                    verifyDepartmentCode: "This department is already exist!",
