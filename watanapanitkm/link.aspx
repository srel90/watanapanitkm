<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="link.aspx.cs" Inherits="wattanapanitkm.link" %>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<h3 class="panel-title">Link Management</h3>
								</div>
								<div class="panel-body">
									...
									<div class="panel panel-default" <% Response.Write(!((System.Data.DataTable)Session["USER"]).Rows[0]["username"].ToString().Equals("admin") ? "style=\"display:none\"" : ""); %>>
										...
										<div class="panel-body">
											<form class="form-horizontal" role="form" id="scriptForm" name="scriptForm" method="post" action="link.aspx" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="url" class="form-control" id="txt-path" name="path" placeholder="Http://" required validationMessage="Link is required!">
                                                    </div>
                                                </div>	
												<div class="form-group">
		...
		<script type="text/javascript">
		    ...
		    var script = new function () {
		        ...
		        this.initial = function () {
		            ...
		            $("#data-grid").kendoGrid({
		                ...
		                columns: [
							...
							{ field: "linkID", title: "ID" },
                            <% } %>
							{ field: "title", title: "Title" },
                            { title: "Link", template: '<a href="#:path#" target="_blank">#:title#</a>' },
		                ],
		                ...
		                <% } %>
                            { template: '&nbsp;<input type="text" id="txt-search" style="height:25px">&nbsp;<button type="button" class="btn btn-primary" id="btn-search" onClick="script.searchLink()"><span class="glyphicon glyphicon-search"></span>Search</button>' }
		                ]
		        ...
		        this.searchLink = function () {
		            $("#data-grid").data("kendoGrid").dataSource.read({ search: $('#txt-search').val(), mode: 'searchLink' });
		        }
