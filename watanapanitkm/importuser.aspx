<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="importuser.aspx.cs" Inherits="wattanapanitkm.importuser" %>
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>Import JTDA users</h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
                    <li class="active">Import JTDA users</li>
                </ol>
            </section>
            <!-- Main content -->
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">JTDA users</h3>
                            </div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" id="scriptForm" name="scriptForm" method="post" action="importuser.aspx" enctype="multipart/form-data">
                                    <input type="hidden" id="txt-mode" name="mode" value="import">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">JTDA users excel file</label>
                                        <div class="col-sm-6">
