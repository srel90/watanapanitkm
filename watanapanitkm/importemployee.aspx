<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="importemployee.aspx.cs" Inherits="wattanapanitkm.importemployee" %>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" id="scriptForm" name="scriptForm" method="post" action="importemployee.aspx" enctype="multipart/form-data">
                                    <input type="hidden" id="txt-mode" name="mode" value="import">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Employee excel file</label>
                                        <div class="col-sm-6">
